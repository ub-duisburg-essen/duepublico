...
<xsl:stylesheet version="1.0" xmlns:mods="http://www.loc.gov/mods/v3" xmlns:xalan="http://xml.apache.org/xalan" xmlns:xlink="http://www.w3.org/1999/xlink"
    ...
    <xsl:template match="/">
        <xsl:text>Titel;Nebensachtitel;Autoren;Herausgeber;Betreuer;erschienen in;Buch-Autoren;Konferenz;Konferenz-Zeitraum;Veranstaltungsort;Genre;Seitenangaben;Heftangaben;Bandangaben;ISBN / ISSN;URN;DOI;DuEPublico-ID;Verlag;Verlagsort;Veröffentlichungsdatum;Institution&#xA;</xsl:text>
    ...
    <xsl:template name="convertToCsv">
        ...
        <!-- DuEPublico-ID -->
        <xsl:call-template name="convertStringToCsv">
            <xsl:with-param name="cstring" select="mods:identifier[@type='citekey']" />
        </xsl:call-template>
