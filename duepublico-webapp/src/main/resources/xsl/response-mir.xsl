...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:mods="http://www.loc.gov/mods/v3" xmlns:encoder="xalan://java.net.URLEncoder"
  ...
  xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:decoder="xalan://java.net.URLDecoder" exclude-result-prefixes="i18n mods str exslt mcr acl mcrxsl basket encoder decoder xlink"
>
...
<!-- Filter, Pagination & Trefferliste -->
    <div class="row result_body">
      <div class="col-xs-12 col-sm-4 result_filter" style="padding-left:34px;">

        <form class="basket_form" action="{$ServletsBaseURL}MCRBasketServlet{$HttpSession}" method="post" style="width:100%; margin-top:0;">
          ...
          <button type="submit" tabindex="1" class="btn-primary form-control" value="add">
      ...
      <!-- ENDE: alle zu basket -->
        ...
        <xsl:if test="/response/lst[@name='facet_counts']/lst[@name='facet_fields'] and $hits &gt; 0">
          <div class="panel panel-default" style="width:100%; margin-right:1px;">
