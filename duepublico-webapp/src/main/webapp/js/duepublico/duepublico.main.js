    ...
    <div class="panel-body">
        ...
        <div class="form-inline controls">
            <select class="form-control form-control-inline" id="statisticsFromMonth">
                <option title="1" value="1">Januar</option>
                <option title="2" value="2">Februar</option>
                <option title="3" value="3">März</option>
                <option title="4" value="4">April</option>
                <option title="5" value="5">Mai</option>
                <option title="6" value="6">Juni</option>
                <option title="7" value="7">Juli</option>
                <option title="8" value="8">August</option>
                <option title="9" value="9">September</option>
                <option title="10" value="10">Oktober</option>
                <option title="11" value="11">November</option>
                <option title="12" value="12">Dezember</option>
            </select>
...
`;
        ...
        $("#statisticsStarter").click(function() {
            ...
            var statisticsToMonth = $("#statisticsFromMonth option:selected").text();
            var statisticsToYear = $("#statisticsFromMonth option:selected").text();
            ...
            console.log("duepublico.main.js - $(#statisticsStarter).click: do Ajax Request to URL " + statisticsUrl);
        });
    }
});