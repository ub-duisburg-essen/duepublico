  ...
  <xsl:template match="/">
    ...
    <xsl:if test="mycoreobject/metadata/def.modsContainer/modsContainer/mods:mods/mods:accessCondition[contains('copyrightMD|use and reproduction', @type)]">
      <div id="mir-access-rights">
        ...
        <xsl:for-each select="mycoreobject/metadata/def.modsContainer/modsContainer/mods:mods/mods:accessCondition[@type='copyrightMD']">
        ...
        <xsl:for-each select="mycoreobject/metadata/def.modsContainer/modsContainer/mods:mods/mods:accessCondition[@type='use and reproduction']">
          <div class="text-center">
            ...
            <xsl:for-each select="$licenses/mycoreclass//category[@ID=$license_id]">
              <xsl:choose>
            ...
            <xsl:if test="not($licenses/mycoreclass//category[@ID=$license_id])">
              <xsl:value-of select="text()" />
            </xsl:if>
