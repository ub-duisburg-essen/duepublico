  ...
  <xsl:template match="/site">
    <html lang="{$CurrentLang}" class="no-js">
      <head>
        ...
        <script type="text/javascript" src="{$WebApplicationBaseURL}js/duepublico/duepublico.main.js" ></script>
      ...
      <body>
        ...
        <script type="text/javascript" src="{$WebApplicationBaseURL}js/duepublico/base.js"></script>
        <script>
